...
#miros = mirror[0]
#mxi,myi = zip(*miros)
# xg = sorted_ghost_nodes[2][25][0]
# yg = sorted_ghost_nodes[2][25][1]
# xf = sorted_first_interface[2][25][0]
# yf = sorted_first_interface[2][25][1]
...
# plt.scatter(mxi,myi,color = "#6E3333")

# plt.scatter(xg,yg, s =7, color = 'blue')
# plt.scatter(xf,yf, s =7, color =  "#000000")
